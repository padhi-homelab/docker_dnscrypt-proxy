...
`dnscrypt-proxy.toml` configuration file:
    ...
    urls = ['https://raw.githubusercontent.com/padhi-homelab/docker_dnscrypt-proxy/master/resolvers.md']
    minisign_key = 'RWQl3IVwr9SBWW5G0sqzYLkyLq4bhTeQOocdEtC+V/7N4HWlDzvr5+4q'
